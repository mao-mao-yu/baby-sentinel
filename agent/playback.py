...
class Playback:
    def __init__(self, white_noise=None) -> None:
        self._pa = pyaudio.PyAudio()
        # Optional WhiteNoiseKeepAlive: paused around each play_* so the
        # foreground stream can acquire the audio device (ALSA = 1 stream/device).
        self._wn = white_noise
